...
for i in range(1,50):
  ip=[]  
  url="https://www.imdb.com/title/tt0109830/reviews?ref_=tt_ql_3"+str(i)
...
with open("D:/Module 18 -Text_mining/stopwords.txt","r") as sw:
        stop_words = sw.read()
...
with open("D:/Module 18 -Text_mining/positive-words.txt","r") as pos:
...
with open("D:/Module 18 -Text_mining/negative-words.txt", "r") as neg:
